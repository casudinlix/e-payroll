...
<link href="<?php echo tema() ?>admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
	<img src="<?php echo tema() ?>admin/pages/media/pages/earth.jpg" class="img-responsive" alt="">
</div>
